...
// runEncoderTests evaluates a decodeFunc against test data
...
func TestUI01ToBool(t *testing.T) {
	...
	tests := []decoderTest{
		...
		decoderTest{[]byte("\x00\x00\x00\x02"), zero, fmt.Errorf(fmtTooBig, 2)},
		decoderTest{[]byte("\x00\x00\x00\xFF"), zero, fmt.Errorf(fmtTooBig, 255)},
		decoderTest{[]byte("\x00\x00\xFF\x00"), zero, fmt.Errorf(fmtTooBig, 65280)},
		decoderTest{[]byte("\x00\xFF\x00\x00"), zero, fmt.Errorf(fmtTooBig, 16711680)},
		decoderTest{[]byte("\xFF\x00\x00\x00"), zero, fmt.Errorf(fmtTooBig, 4278190080)},
...
func TestSetUI01FromString(t *testing.T) {
	...
	tests := []decoderTest{
		...
		decoderTest{[]byte("\xFF"), "255", nil},
		decoderTest{[]byte("\x00\x00"), "", byteCountErr(2)},
		decoderTest{[]byte("\xFF\xFF"), "", byteCountErr(2)},
		decoderTest{[]byte(""), "", byteCountErr(0)},
	}
	runDecoderTests(t, tests, func(input []byte) (interface{}, error) {
		return UI08ToString(input)
